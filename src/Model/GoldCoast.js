...
class GoldCoast extends AwajiShima {
  ...
  calculateDiagnosis() {
    ...
    return {
      diagnosis:  "ALS",
      explanation: `This scenario is classified as ALS as there is upper and lower motor neuron dysfunction noted in the same body region with only one region being involved.`
    };
  }
    ...
    return {
      diagnosis:  "ALS",
      explanation: `This scenario is classified as ALS as there is upper and lower motor neuron dysfunction noted in at least 1 body region.`
    };
  }
      ...
      return {
        diagnosis:  "ALS",
        explanation: `This scenario is classified as ALS as there is lower motor neuron dysfunction in at least 2 body regions.`
      };
    }
    ...
    return {
      diagnosis: "--",
      explanation: `A valid diagnosis is not available for the selected findings based on the Gold Coast criteria.`
    };
    }
  }
